...
subtitle: "Part 3: Multilevel models and Bayesian statistics"
...
knitr::include_graphics("../images/lme4notation.png")
```
...
library(brms)
fake_data <- data.frame(x = as.factor(sample(paste0('school',1:20), 500, replace = TRUE)))

fake_data$y <- rbinom(500,1,inv_logit_scaled(rnorm(20,0,1)[as.numeric(fake_data$x)]))
